package com.general
{
   ...
   public class Amath
   {
      ...
      public static function rounding(param1:int) : String
      {
         if(param1 >= 10000 && param1 < 100000)
         {
            return int(Math.floor(param1 / 100) * 100) / 1000 + "k";
         }
         if(param1 >= 100000 && param1 < 1000000)
         {
            return int(Math.floor(param1 / 1000) * 1000) / 1000 + "k";
         }
         if(param1 >= 1000000)
         {
            return int(Math.floor(param1 / 100000) * 100000) / 1000000 + "m";
         }
         return param1 + "";
      }
