package com.mygame.screens
{
   ...
   public class Panel_Potions extends Sprite
   {
      ...
      public function Init() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < GV.potions.length)
         {
            _loc2_ = new Cell_inventory();
            _loc2_.Init(_loc1_,"potions");
      ...
      {
         GV.potions.push(param1);
         var _loc2_:Cell_inventory = new Cell_inventory();
         _loc2_.Init(GV.potions.length - 1,"potions");
         this._sprite.addChild(_loc2_);
         this._arr.push(_loc2_);
         this.Disposition();
      }
