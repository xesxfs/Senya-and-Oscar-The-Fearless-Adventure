   ...
   public class ScreenSettings extends ScrBase
   {
      ...
      public function touch_btns(param1:Event) : void
      {
         ...
         if(_loc2_ as Button == this._btnReset)
         {
            ...
            if(this._numCheat == 5)
            {
               GV.game.SM.open_screen("Cheat");
            }
            else
            {
               GV.game.SM.open_screen("ResetData");
            }
         }
      ...
      override public function draw() : void
      {
         ...
         this._resetTxt.format.setTo("PUTIN",17,2429958,"center");
         ...
         this._rateTxt.format.setTo("PUTIN",17,2429958,"center");
         ...
         var _loc4_:TextField = new TextField(100,30,"EN");
         _loc4_.format.setTo("PUTIN",17,2429958,"center");
         ...
         _loc5_.format.setTo("PUTIN",17,2429958,"center");
